...
public class Test_Steps{
	...
	public void user_enters_testuser__and_Test(DataTable usercredentials) throws Throwable {
		...
		findElement(By.id("txtUsername")).sendKeys(data.get(0).get(0)); 
	    findElement(By.id("txtPassword")).sendKeys(data.get(0).get(1));
   ...
   // @Then("^I created Nationality Record Indian(\\d+)$")
    public void I_created_Nationality_Record(DataTable NationalityData) throws Throwable {
		...
		findElement(By.id("btnAdd")).click();
		findElement(By.id("nationality_name")).sendKeys(data.get(0).get(0));
		findElement(By.id("btnSave")).click();
    }
